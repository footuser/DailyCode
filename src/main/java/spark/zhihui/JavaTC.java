...
public final class JavaTC {
  ...
  static class ProjectFn implements PairFunction<Tuple2<Integer, Tuple2<Integer, Integer>>,
     ...
     * 
     */
    private static final long serialVersionUID = -5511041840436942520L;
  ...
  public static void main(String[] args) {
    SparkConf sparkConf = new SparkConf().setAppName("JavaHdfsLR");//.setMaster("local[4]");
    ...
    JavaPairRDD<Integer, Integer> edges = tc.mapToPair(
      new PairFunction<Tuple2<Integer, Integer>, Integer, Integer>() {
         ...
         * 
         */
        private static final long serialVersionUID = -6025345968385153506L;
