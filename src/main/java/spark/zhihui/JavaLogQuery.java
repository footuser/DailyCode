...
/**
 * Executes a roll up-style query against Apache logs. Usage: JavaLogQuery
 * [logFile]
 */
public final class JavaLogQuery {
     ...
     * 
     */
        private static final long serialVersionUID = 7321505069439150723L;
    ...
    public static void main(String[] args) {
        ...
        JavaPairRDD<Tuple3<String, String, String>, Stats> extracted = dataSet
                .mapToPair(new PairFunction<String, Tuple3<String, String, String>, Stats>() {
                    private static final long serialVersionUID = 3504392859707765938L;
        ...
        JavaPairRDD<Tuple3<String, String, String>, Stats> counts = extracted
                .reduceByKey(new Function2<Stats, Stats, Stats>() {
                    private static final long serialVersionUID = 969451729111835115L;
        ...
        for (Tuple2<?, ?> t : output) {
         ...
         counts.saveAsTextFile(args.length == 1 ? args[0] : args[1]);
        // counts.saveAsHadoopFile(args.length == 1 ? args[0] : args[1],
